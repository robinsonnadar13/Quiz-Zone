...
$sql = "INSERT INTO customquiz (QuizID, username, QuizName, FirstQuestion, OptionOneOne, OptionOneTwo, OptionOneThree, OptionOneFour, AnswerOne, SecondQuestion, OptionTwoOne, OptionTwoTwo, OptionTwoThree, OptionTwoFour, AnswerTwo, ThirdQuestion, OptionThreeOne, OptionThreeTwo, OptionThreeThree, OptionThreeFour, AnswerThree, gamemode)
           VALUES (:QuizID, :username, :QuizName, :FirstQuestion, :OptionOneOne, :OptionOneTwo, :OptionOneThree, :OptionOneFour, :AnswerOne, :SecondQuestion, :OptionTwoOne, :OptionTwoTwo, :OptionTwoThree, :OptionTwoFour, :AnswerTwo, :ThirdQuestion, :OptionThreeOne, :OptionThreeTwo, :OptionThreeThree, :OptionThreeFour, :AnswerThree, :gamemode)";
  ...
  header('Location: create-quiz6.php');
}
